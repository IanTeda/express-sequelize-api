...
describe('Integration :: Confirm Email Tokens :: Authorization', () => {
    ...
    it('expect to be denied to create any', (done) => {
      ...
      chai
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.have.property('message').to.equals(`AUTHORIZATION ERROR: You are not authorized to POST resources on ${resources.CONFIRM_EMAIL_TOKENS}.`);
          done();
        });
    });
