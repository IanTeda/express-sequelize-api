...
describe('Unit :: Config :: Logger', () => {
  it('expect logger.config to have console & file option', (done) => {
    expect(logger).to.have.property('console');
    expect(logger).to.have.property('file');
    done();
  });

  it('expect logger.config.console to be configured', (done) => {
  ...
  it('expect logger.config.file to be configured', (done) => {
  ...
  it('expect logger.config to default silent and level emerg when testing', () => {
