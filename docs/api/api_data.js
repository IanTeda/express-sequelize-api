        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<ul> <li>ConfirmEmailToken primary key id.</li> </ul>"
          },
          {
            "group": "Success 200",
            "type": "Int",
            "optional": false,
            "field": "UserId",
            "description": "<ul> <li>Foreign key of user associated to token.</li> </ul>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "token",
            "description": "<ul> <li>Token to use for confirming users email address.</li> </ul>"
          },
          {
            "group": "Success 200",
            "type": "Date",
            "optional": false,
            "field": "expiration",
            "description": "<ul> <li>The expiration date for the confirm email token.</li> </ul>"
          }
        ]
      }
    },
    "version": "0.0.0",
    "filename": "src/routes/confirmEmailToken.route.js",
    "groupTitle": "ConfirmEmailToken"
  },
  {
    "type": "delete",
    "url": "/confirm-email-tokens",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<ul> <li>A count of the confirm email tokens destroyed.</li> </ul>"
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": true,
            "field": "limit",
            "description": "<ul> <li>Optional limit to query. Will default to 10.</li> </ul>"
          },
          {
            "group": "Parameter",
            "type": "Int",
            "optional": true,
            "field": "offset",
            "description": "<ul> <li>Optional pagination offset based on limit. Will default to 0</li> </ul>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": true,
            "field": "where",
            "description": "<ul> <li>Optional query filter.</li> </ul> <p>// TODO: This isn't right</p>"
          }
        ]
      }
    },
